"""
preview_wooden_boat.py
======================
Three-view preview render for the wooden rowboat: side, 3/4, and a
top-down look so the hollow interior + thwart layout is visible.

Run:
  /Applications/Blender.app/Contents/MacOS/Blender --background \
      --python preview_wooden_boat.py
"""
...
GLB_PATH = os.path.abspath("viewer/public/buildings/WoodenBoat.glb")

WIDTH, HEIGHT = 1000, 700
VIEWS = [
    # 3/4 from bow-starboard-up — shows the hull curve, the rise of the
    # bow, and the interior (with thwarts) all in one frame.
    ("wooden_boat_preview_3q.png",
     Vector((0.80, 0.55, 0.55)).normalized()),
    # Pure side profile — sells the sheer curve of the gunwale + bow rise.
    ("wooden_boat_preview_side.png",
     Vector((1.00, 0.00, 0.08)).normalized()),
    # Top-down (slightly forward-canted) — shows the interior floor,
    # gunwale rim, thwart positions, and the boat's plan-view shape.
    ("wooden_boat_preview_top.png",
     Vector((0.05, 0.05, 1.00)).normalized()),
]
FRAME_MARGIN = 1.15
